				...
				if( json && json[0] ){
					...
					if( json[0].fittingRoomSummaryList ){
						...
						if( catTypesPageNums[currentCatType] < catTypesMaxPages[currentCatType] ){
							...
							// console.log("catTypesPageNums[currentCatType]: "+catTypesPageNums[currentCatType]+" catTypesMaxPages[currentCatType]: "+catTypesMaxPages[currentCatType]+" currentCatType: "+currentCatType);
