...
(function($services){
	...
	$services.getNewspapers = function(custId){
		return($.ajax({
			type: 'GET',
			data: 'action=getNewspapers&custId=' + custId,
			url: '/salebynow/np.htm'
		}));
	};
...
//	};
	...
	$services.unFollow = function(following){
		return($.ajax({
			type: 'POST',
    ...
    $services.addFollowing = function(following){
        return($.ajax({
            type: 'POST',
    ...
    $services.sharePhotoInfoViaEmail = function(email, comments, type, headline, photo_url, name, oped, who, what, when, where, how, why){
        var tempData = {
    ...
    $services.shareNPTemplateInfoViaEmail = function(npid, headline, emails){
        return($.ajax({
            type: 'POST',
    ...
    $services.getNotificationTrayDetails = function(num, pageNum){
        return($.ajax({
            type: 'GET',
